...
const MenubarContentElement = React.forwardRef<React.ElementRef<typeof MBAR.Content>, MenubarContentProps>(
  ...
  ({ children, className, ...rest }, ref) => {
    return (
      <MBAR.Item
        {...rest}
        ref={ref}
        className={clsx(className, CSS.menubar_item)}>
        {children}
      </MBAR.Item>
    );
  },
...
const MenubarTriggerElement = React.forwardRef<React.ElementRef<typeof MBAR.Trigger>, MenubarTriggerProps>(
  ({ children, className, ...rest }, ref) => {
    return (
      <MBAR.Trigger
        {...rest}
        ref={ref}
        className={clsx(className, CSS.menubar_trigger)}>
        {children}
      </MBAR.Trigger>
    );
  },
...
const MenubarSubTriggerElement = React.forwardRef<React.ElementRef<typeof MBAR.SubTrigger>, MenubarSubTriggerProps>(
  ({ children, className, ...rest }, ref) => {
    return (
      <MBAR.SubTrigger
        {...rest}
        ref={ref}
        className={clsx(className, CSS.submenu_trigger)}>
        {children}
      </MBAR.SubTrigger>
    );
  },
...
const MenubarSubContentElement = React.forwardRef<React.ElementRef<typeof MBAR.SubContent>, MenubarSubContentProps>(
