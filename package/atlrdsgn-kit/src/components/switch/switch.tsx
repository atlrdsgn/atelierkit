...
const SwitchToggleComponent = React.forwardRef<React.ElementRef<typeof SWI.Thumb>, ToggleProps>(
  (props, ref) => {
    const {className, asChild = false, ...rest} = props
    return <SWI.Thumb {...rest} ref={ref} className={clsx(className, css.switch_toggle)} />
  }
)
