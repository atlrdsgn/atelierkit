...
const SIZE_MAP = {} as const
const VARIANT_COLOR_MAP = {} as const
...
export const select_trigger = style({
  ...
  [kit.selector.HOV]: {backgroundColor: kit.color.slate3},
  [kit.selector.FOC]: {boxShadow: `0 0 0 2px ${kit.color.hyper4}`},
...
export const select_item = style({
  ...
  [kit.selector.FOC]: {
    outline: 'none',
    WebKitFocusRingColor: kit.color.transparent,
  },
